...
# 꺾은선 그래프 예시 (고급화)
fig = px.line(df_hours_metrics, x='연도', y='값', markers=True, 
              title="시간대별 근로 시간 변화",
              template="plotly_white") # 깔끔한 흰색 배경
fig.update_traces(line_color='#0044aa', line_width=3) # 강조 색상
...
- **청년일자리지원서비스** [청년일자리지원서비스홈페이지](https://opendata.alio.go.kr/new/main.do)
